...
import 'package:flutter_app_instaclone/screens/comments/bloc/comments_bloc.dart';
          ...
          body: ListView.builder(
              ...
              itemBuilder: (BuildContext context, int index) {
                ...
                return ListTile(
                  ...
                  onTap: () => Navigator.of(context).pushNamed(ProfileScreen.routeName,arguments: ProfileScreenArgs(userId: comment.author.id)),
                );
              }),
          bottomSheet: Padding(
            ...
            children: [
              ...
              IconButton(onPressed: (){
                ...
                if(content.isNotEmpty){
                  context.read<CommentsBloc>().add(CommentsPostComment(content: content));
